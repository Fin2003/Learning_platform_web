...
function IconButton({
  ...
  return (
    ...
    >
      <motion.div
        className={cn(
          ...
          invertIcon
            ...
            : "stroke-muted-foreground group-hover/icon-button:stroke-[var(--icon-button-color)]",
        )}
        aria-hidden="true"
      >
      ...
      {/* Invert overlay with fade in/out */}
      <AnimatePresence>
        {invertIcon && (
          <motion.div
            className="absolute inset-0 grid place-items-center text-[var(--icon-button-color)] fill-white"
            aria-hidden="true"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
      ...
      <AnimatePresence mode="wait">
        {active && popIcon && (
          <motion.div
            className="absolute inset-0 grid place-items-center text-[var(--icon-button-color)] fill-[var(--icon-button-color)]"
            aria-hidden="true"
